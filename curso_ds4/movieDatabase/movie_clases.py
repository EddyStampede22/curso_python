...
class Actor:
    ...
    def __str__(self):
        ''' Devuelve un string con la información del actor '''
        return self.nombre   
...
class Pelicula:
    ...
    def __str__(self):
        ...
        return f"{self.titulo_pelicula:35s} {self.fecha_lanzamiento.year}"
...
if __name__ == '__main__':
    ...
    for pelicula in lista_peliculas:
        print(f"{pelicula.id}:{pelicula.titulo_pelicula:35s} - {pelicula.fecha_lanzamiento.year}")
